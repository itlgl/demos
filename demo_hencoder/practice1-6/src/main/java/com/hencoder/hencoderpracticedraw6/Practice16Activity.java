...
public class Practice16Activity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
...

    {
        ...
        pageModels.add(new PageModel(R.layout.sample_scale16, R.string.title_scale, R.layout.practice_scale16));
