...
public class Practice14Activity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
...

    {
        ...
        pageModels.add(new PageModel(R.layout.practice15_test_matrix, R.string.title_test_matrix, R.layout.practice15_test_matrix));
    }
