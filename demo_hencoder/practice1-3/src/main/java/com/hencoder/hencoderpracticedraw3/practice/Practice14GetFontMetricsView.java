...
public class Practice14GetFontMetricsView extends View {
...

    {
        ...
        Paint.FontMetrics textMetrics = new Paint.FontMetrics();
        textMetrics = paint2.getFontMetrics();
        // yOffset = (textMetrics.bottom - textMetrics.top) / 2 - textMetrics.bottom;
        yOffset = - (textMetrics.ascent + textMetrics.descent) / 2;
    }
